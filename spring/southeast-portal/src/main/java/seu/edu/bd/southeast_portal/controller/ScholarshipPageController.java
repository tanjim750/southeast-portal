...
import seu.edu.bd.southeast_portal.service.tuition.ScholarshipPageService;

import java.util.HashMap;
import java.util.Map;

@RestController
@RequestMapping("/api/v1/page/scholarship")
public class ScholarshipPageController {
    @Autowired
    private ScholarshipPageService service;
    ...
    @PostMapping("/add")
    public ResponseEntity<?> add(@RequestBody ScholarshipPage body){
        return service.add(body);
    }

    @PutMapping("/update/{id}")
    public ResponseEntity<?> update(@RequestBody ScholarshipPage body, @PathVariable String id){
