...
import seu.edu.bd.southeast_portal.repository.academic.ScholarshipRepo;
...
public class ScholarshipService {
    ...
    public ResponseEntity<?> getById(Long id){
        Map<String, Object> response = new HashMap<>();
        Scholarship getInfo = repo.findById(id).orElse(null);
        if (getInfo == null) {
            response.put("status","failed");
    ...
    public ResponseEntity<?> add(Scholarship info){
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> update(Scholarship info,Long id){
        Map<String, Object> response = new HashMap<>();
        Scholarship getInfo = repo.findById(id).orElse(null);
