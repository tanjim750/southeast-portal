...
import seu.edu.bd.southeast_portal.service.header.HeaderService;

import java.util.HashMap;
import java.util.Map;

@RestController
@RequestMapping("/api/v1/page/header")
public class HeaderController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> add(@RequestBody Header body){
        return service.add(body);
    }

    @PutMapping("/update/{id}")
    public ResponseEntity<?> update(@RequestBody Header body, @PathVariable String id){
