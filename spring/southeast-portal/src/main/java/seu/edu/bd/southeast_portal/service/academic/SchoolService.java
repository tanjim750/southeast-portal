...
import seu.edu.bd.southeast_portal.repository.academic.SchoolRepo;
...
public class SchoolService {
    ...
    public ResponseEntity<?> getById(Long id){
        Map<String, Object> response = new HashMap<>();
        School getInfo = repo.findById(id).orElse(null);
        if (getInfo == null) {
            response.put("status","failed");
    ...
    public ResponseEntity<?> add(School info){
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> update(School info,Long id){
        Map<String, Object> response = new HashMap<>();
        School getInfo = repo.findById(id).orElse(null);
