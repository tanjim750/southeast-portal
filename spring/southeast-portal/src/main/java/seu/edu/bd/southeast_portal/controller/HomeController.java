...
import seu.edu.bd.southeast_portal.service.home.HomeService;

import java.util.HashMap;
import java.util.Map;

@RestController
@RequestMapping("/api/v1/page/home")
public class HomeController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> add(@RequestBody Home body){
        return service.add(body);
    }


    @PutMapping("/update/{id}")
    public ResponseEntity<?> update(@RequestBody Home body, @PathVariable String id){
        System.out.println("\n###########################\n");
