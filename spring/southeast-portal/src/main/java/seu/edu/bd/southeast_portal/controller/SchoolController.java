...
import seu.edu.bd.southeast_portal.service.academic.SchoolService;
...
public class SchoolController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> add(@RequestBody School body){
        return service.add(body);
    }

    @PutMapping("/update/{id}")
    public ResponseEntity<?> update(@RequestBody School body, @PathVariable String id){
