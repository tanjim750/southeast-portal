...
import seu.edu.bd.southeast_portal.repository.tuition.TuitionPageRepo;
...
@Service
public class TuitionPageService {
    @Autowired
    private TuitionPageRepo repo;

    public ResponseEntity<?> getAll(){
        Map<String, Object> response = new HashMap<>();
        List<TuitionPage> all = repo.findAll();
        if (all.isEmpty()) {
    ...
    public ResponseEntity<?> getById(Long id){
        Map<String, Object> response = new HashMap<>();
        TuitionPage getInfo = repo.findById(id).orElse(null);
        if (getInfo == null) {
            response.put("status","failed");
    ...
    public ResponseEntity<?> add(TuitionPage info){
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> update(TuitionPage info,Long id){
        Map<String, Object> response = new HashMap<>();
        TuitionPage getInfo = repo.findById(id).orElse(null);
