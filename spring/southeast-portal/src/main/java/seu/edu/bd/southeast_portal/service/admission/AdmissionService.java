package seu.edu.bd.southeast_portal.service.admission;
...
import seu.edu.bd.southeast_portal.repository.admission.AdmissionRepo;
...
public class AdmissionService {
    ...
    public ResponseEntity<?> getAll(){
        ...
        List<Admission> all = repo.findAll();
        if (all.isEmpty()) {
    ...
    public ResponseEntity<?> getById(Long id){
        Map<String, Object> response = new HashMap<>();
        Admission getInfo = repo.findById(id).orElse(null);
        if (getInfo == null) {
            response.put("status","failed");
    ...
    public ResponseEntity<?> add(Admission info){
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> update(Admission info,Long id){
        Map<String, Object> response = new HashMap<>();
        Admission getInfo = repo.findById(id).orElse(null);
