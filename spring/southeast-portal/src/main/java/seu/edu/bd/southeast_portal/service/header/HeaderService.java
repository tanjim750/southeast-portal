package seu.edu.bd.southeast_portal.service.header;
...
import seu.edu.bd.southeast_portal.repository.header.HeaderRepo;
...
public class HeaderService {
    @Autowired
    private HeaderRepo repo;

    public ResponseEntity<?> getAll(){
        Map<String, Object> response = new HashMap<>();
        List<Header> all = repo.findAll();
        if (all.isEmpty()) {
    ...
    public ResponseEntity<?> getById(Long id){
        Map<String, Object> response = new HashMap<>();
        Header getInfo = repo.findById(id).orElse(null);
        if (getInfo == null) {
            response.put("status","failed");
    ...
    public ResponseEntity<?> add(Header info){
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> update(Header info,Long id){
        Map<String, Object> response = new HashMap<>();
        Header getInfo = repo.findById(id).orElse(null);
