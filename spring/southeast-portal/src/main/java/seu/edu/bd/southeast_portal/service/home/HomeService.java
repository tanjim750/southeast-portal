package seu.edu.bd.southeast_portal.service.home;
...
import seu.edu.bd.southeast_portal.repository.home.HomeRepo;
...
public class HomeService {
    ...
    public ResponseEntity<?> getById(Long id){
        Map<String, Object> response = new HashMap<>();
        Home getInfo = repo.findById(id).orElse(null);
        if (getInfo == null) {
            response.put("status","failed");
    ...
    public ResponseEntity<?> add(Home info){
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> update(Home info,Long id){
        Map<String, Object> response = new HashMap<>();
        Home getInfo = repo.findById(id).orElse(null);
